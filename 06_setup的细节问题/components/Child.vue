...
export default defineComponent({
  ...
  // setup中的对象中的属性和data函数中的对象中的属性合并为组件对象的属性
  ...
  // setup(props,context) {
    ...
    // props参数,是一个对象,里面有父级组件向自己组件传递的数据,并且是在子级组件中使用props接收到的所有的属性
    // 包含props配置声明且传入了的所有属性的对象
    // console.log(props.msg);
    // console.log(context.attrs);
    // console.log(context.emit);
    // context参数,是一个对象,里面有attrs对象(获取当前组件标签上的所有属性的对象,但是该属性是在props中没有声明接收的所有的属性的对象),emit方法(分发事件的),slots对象(插槽)
